 ...
 */
public class ThongKeDoanhThu_VIEW {
    ...
    public String[] column = {"STT", "Thời gian","Tiền vốn","Tiền lãi", "Tổng doanh thu"};
    public String[][] data = {};
    ...
    public JRadioButton jrb_TheoNgayTrongThang;
    public JRadioButton jrb_TheoThangTrongNam;
    public JRadioButton jrb_TheoNam;
    ...
    public ThongKeDoanhThu_VIEW(JPanel pnl_input, JPanel pnl_tuongtac, JPanel top_content, JPanel pnl_contentbottom, JPanel pnl_information) {
    ...
    public void init() {
        MouseListener mouseListener = new ThongKeDoanhThu_CONTROLLER(this);
        ActionListener actionListener = new ThongKeDoanhThu_CONTROLLER(this);
        ...
        jrb_TheoNgayTrongThang = new JRadioButton("Theo ngày trong tháng");
        jrb_TheoNgayTrongThang.setBackground(Color.WHITE);
        jrb_TheoNgayTrongThang.addActionListener(actionListener);
        jrb_TheoThangTrongNam = new JRadioButton("Theo tháng trong năm");
        jrb_TheoThangTrongNam.setBackground(Color.WHITE);
        jrb_TheoThangTrongNam.addActionListener(actionListener);
        jrb_TheoNam = new JRadioButton("Theo năm");
        jrb_TheoNam.setBackground(Color.WHITE);
        jrb_TheoNam.addActionListener(actionListener);
        ...
        buttonGroup_LuaChonJRB.add(jrb_TheoNgayTrongThang);
        buttonGroup_LuaChonJRB.add(jrb_TheoThangTrongNam);
        buttonGroup_LuaChonJRB.add(jrb_TheoNam);;
        ...
        jPanel_LuaChonJRB.add(jrb_TheoNgayTrongThang);
        jPanel_LuaChonJRB.add(jrb_TheoThangTrongNam);
        jPanel_LuaChonJRB.add(jrb_TheoNam);
...
//        Query<order_data> query = session.createQuery("FROM order_data WHERE OrderID >= : a ");
//        query.setParameter("a", 1);
//        list = query.list();
//        transaction.commit();
        
//        List<order_data> list = thongKeDoanhThu_BLL.getTKDT_TheoNgayTrongThang();
//        
//        int rows = list.size();
//        int cols = 3;
