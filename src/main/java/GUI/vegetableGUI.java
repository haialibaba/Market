...
public class vegetableGUI {
    ...
    public vegetableGUI(JPanel pnl_input, JPanel pnl_tuongtac, JPanel top_content, JPanel pnl_information,JPanel pnl_contentbottom) {
    ...
    public void init(){
        ...
        public void congcu(){
           ...
           public void inner_imgVe(ImageIcon icon){
            ...
            String[] colum={"ID","Name","Unit","Amount","Image","Price"};
            String[][] row={};
    ...
    public void loadNV(int cateID){
      ...
      List vegetableList = cateBLL.getCategory(cateID).getVegetables();
        ...
        CategoryModel model= new CategoryModel(newList);
            ...
            combobox_vegeType.addItem("Chọn Loại");
